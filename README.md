# Michael's Resume
Templated from gatsby-starter-resume, by [Anubhav Srivastava](https://github.com/anubhavsrivastava/gatsby-starter-resume)
...
```sh
gatsby new <site-name> https://github.com/keaysma/keaysma.github.io
```
...
Additionally, it also has [path-prefix](https://www.gatsbyjs.org/docs/path-prefix/) value set for gatsby config in `config.js`. Change `pathPrefix` to relevant path if your gatsby site is hosted on subpath of a domain, `https://michaelandrewkeays.com/somePath/`. If you are hosting it as root site, i.e, `https://michaelandrewkeays.com/` , remove the pathPrefix configuration.

### Checkout other similar starters by Anubhav
